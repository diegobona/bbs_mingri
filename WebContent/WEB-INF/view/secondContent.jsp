		...
		<tr>
			<td class="tbl">
				<div style="text-align: center;">
					<p>楼主</p>
					<a>
					<c:if test="${main.base_sex eq '女' }">
            					<img alt="" src="<%=basePath %>image/ico_111.gif" />
            				</c:if>
					<c:if test="${main.base_sex ne '女' }">
				...
				<c:forEach	items="${second}" var="item" varStatus="vs">
					<tr>
						<td class="tbl">
							...
							<a>
							<c:if test="${item.base_sex eq '女' }">
            							<img alt="" src="<%=basePath %>image/ico_111.gif" />
            						</c:if>
							<c:if test="${item.base_sex ne '女' }">
            							<img alt="" src="<%=basePath %>image/ico_000.gif" />
            						</c:if>
							</a>
							</div>
